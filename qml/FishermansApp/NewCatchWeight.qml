...
Item {
    ...
    property string fishGewicht: ""

    function setWeight(fish) {
        fishGewicht = fish
    }
    function getWeight() {
        return fishGewicht
        ...
        Item {
            ...
            MouseArea {
                ...
                onClicked: {
                    ...
                    //console.debug(listModelWeight.get(index).art)
                    setWeight(gewicht)
    ...
    Component.onCompleted: {
        ...
        for (var i = 0; i < 201; i++) {
            ...
            weight = i * 0.1
            if (weight < 1) {
                weightSave = weight.toPrecision(2)
            } else {
                weightSave = weight.toPrecision(3)
            }

            listModelWeight.append({
                                       gewicht: weightSave.toString()
                                   })
        }
    }
}
